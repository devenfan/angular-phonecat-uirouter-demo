      ...
      function ($stateProvider,   $urlRouterProvider) {
        ...
        $stateProvider
          ...
          .state('contacts', {
            ...
            controller: ['$scope', '$state', 'contactsAll', 'utilService',
              function (  $scope,   $state,   contactsAll,   utilService) {

                // Add a 'contacts' field in this abstract parent's scope, so that all
                // child state views can access it in their scopes. Please note: scope
                // inheritance is not due to nesting of states, but rather choosing to
                // nest the templates of those states. It's normal scope inheritance.
                $scope.contacts = contactsAll;

                $scope.goToRandom = function () {
                  var randId = utilService.newRandomKey($scope.contacts, "id", $state.params.contactId);
              ...
              '': {
                ...
                controller: ['$scope', '$stateParams', 'utilService',
                  function (  $scope,   $stateParams,   utilService) {
                    $scope.contact = utilService.findById($scope.contacts, $stateParams.contactId);
                  }]
              },
              ...
              '': {
                ...
                controller: ['$scope', '$stateParams', '$state', 'utilService',
                  function (  $scope,   $stateParams,   $state,   utilService) {
                    $scope.item = utilService.findById($scope.contact.items, $stateParams.itemId);
