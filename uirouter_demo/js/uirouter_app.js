        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                ...
                .state('contacts', {
                    ...
                    resolve: {
                        contactsAll: ['contactsDataService',
                            function (contactsDataService) {
                                return contactsDataService.all();
                            }]
                    },

                    // You can pair a controller to your template. There *must* be a template to pair with.

                    controller: ['$scope', '$state', 'contactsAll', 'contactsUtilService',
                        function ($scope, $state, contactsAll, contactsUtilService) {
